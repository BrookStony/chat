...
<html id="ng-app" ng-app="chatScreen">
<head>
    <meta charset="utf-8">
...
<body>
    <div id="screen_wrap" style="background: #000080 url('${createLinkTo(dir: 'images', file: 'screen/blue/bg.jpg')}') center 0 no-repeat;">
        <div id="screen" ui-view>
