		 ...
		 $(document).ready(function () {
            try {
                $("#js_praise").click(function () {
                    ...
                    var openId = "${article?.openId}";
                    var unionId = "${article?.unionId}";
                    var url = "${createLink(controller: 'oauthArticleView', action: 'praise')}";
                    if("Article" == type) {
                        url = url + "?id=" + id + "&type=" + type + "&openId=" + openId + "&unionId=" + unionId;
                    }
                    else {
                        url = url + "?item_id=" + id + "&type=" + type + "&openId=" + openId + "&unionId=" + unionId;
                    }
                    $.ajax({
                        type: "get",
                        url: url,
