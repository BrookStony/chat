    ...
    '<div class="anti-ie-mask">',
      '<div class="anti-ie-dialog" id="anti-ie-dialog">',
        '<div class="anti-ie-text">',
          ...
          '</p>',
          '<p class="anti-ie-para">',
            '使用IE6/7/8浏览本网站可能会遭遇文字错位，布局混乱，功能失灵等意外情况。',
          '</p>',
          '<p class="anti-ie-para">',
            '为了您的良好浏览体验，请安装以下浏览器：',
          '</p>',
        ...
        '<div class="anti-ie-btn-ctnr">',
          '<input style="display: none" type="checkbox" id="anti-ie-remind"><label style="display: none"  for="anti-ie-remind">30天内不再提醒我</label>&nbsp;&nbsp;',
          '<a style="display: none" class="anti-ie-btn anti-ie-btn-cancel" id="anti-ie-keep-ie" href="javascript:void(0);">继续用低版本IE浏览（不推荐）</a>&nbsp;&nbsp;',
